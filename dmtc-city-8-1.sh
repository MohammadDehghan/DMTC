...
train_set="8"
sid="1"
exp_name="dmtc-city-8-1-contrastiveOnbothImageNetAndCoco"
ep="10"
lr="0.004"
c1="3"
c2="3"
...
echo baselines
python main.py --exp-name=${exp_name}__p0--c --val-num-steps=350 --state=2 --epochs=170 --dataset=city --train-set=${train_set} --sets-id=${sid} --continue-from=city_coco_resnet101.pt --coco --mixed-precision --lr=${lr} --batch-size-labeled=8 --batch-size-pseudo=0 --seed=1 --apply_contrastive
python main.py --exp-name=${exp_name}__p0--i --val-num-steps=350 --state=2 --epochs=170 --dataset=city --train-set=${train_set} --sets-id=${sid} --mixed-precision --lr=${lr} --batch-size-labeled=8 --batch-size-pseudo=0 --seed=2 --apply_contrastive
